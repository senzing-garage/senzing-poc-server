...
public interface SzRelationsPage {
   ...
   *                 of relations to be randomly selected from the
   *                 page of results.
   */
  ...
  /**
   * Gets the {@link List} of {@link SzRelation} instances describing the
  ...
  /**
   * Sets the {@link List} of {@link SzRelation} instances describing the
   * relationships for the page. The {@link SzRelation} instances will
   * be in ascending order of the first entity ID and then the second
   * related entity ID.
   * 
